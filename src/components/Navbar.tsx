    ...
    >
      <motion.nav
        ...
        style={{
          ...
          boxShadow: isScrolled
            ...
            : "6px 6px 16px rgba(0,0,0,0.04), -6px -6px 16px rgba(255,255,255,0.8), inset 1px 1px 2px rgba(255,255,255,0.5)",
      ...
      >
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                className={`
                  relative px-7 py-2.5 text-[15px] font-medium rounded-full transition-all duration-300
                  ${isActive
                    ? "text-zinc-700"
        ...
        <div className="flex-1 flex justify-end shrink-0">
          <Link
            href="/contact"
            className="text-white px-8 py-3 rounded-full text-[15px] font-semibold transition-all duration-300 hover:scale-[1.04] active:scale-95"
            style={{
              background: "linear-gradient(135deg, #FF6B00, #FF5200)",
              boxShadow: "0 6px 20px rgba(255,92,0,0.3), inset 0 1px 1px rgba(255,255,255,0.15)",
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = "0 8px 28px rgba(255,92,0,0.4), inset 0 1px 1px rgba(255,255,255,0.2)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.boxShadow = "0 6px 20px rgba(255,92,0,0.3), inset 0 1px 1px rgba(255,255,255,0.15)";
            }}
          >
            Contact us
          </Link>
